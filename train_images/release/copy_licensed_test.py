'''
Copies test images from the downloaded aircraft and nabirds datasets
...
nabirds_path = 'CCUB_NABIRDS_EBYB/test_images/'
aircraft_path = 'fgvc-aircraft-2013a/data/images/'
fgcomp_test_im_path = 'test_images'

path_dict = {'aircraft':aircraft_path,'birds':nabirds_path}
total_symbols = 50

with open('licensed_ims_test.pkl', 'rb') as im_file:
  ...
  for i, (domain, old_path, new_path) in enumerate(ims):
    ...
    new_path = os.path.join(fgcomp_test_im_path, new_path)
